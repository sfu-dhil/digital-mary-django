...
// HACK: to get tinymce to play nice with django-modeltrans + django-modeltrans-tabs
// (removes load racing condition by using jquery ready)
...
(function () {
  ...
  function initializeTinyMCE(element, formsetName) {
    Array.from(element.querySelectorAll('.tinymce:not(.hidden)')).forEach(area => initTinyMCE(area));
  }
